...
3. Settings:
   ...
   - **Execute as**: `Me`
   - **Who has access**: `Only myself` (most secure — the script still accesses shared calendars via your Google account permissions)
4. Click **Deploy**
