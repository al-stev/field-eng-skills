...
allowed-tools: Bash(uv run --project .claude/skills/gdocs python .claude/skills/gdocs/scripts/setup_auth.py *), Bash(openssl rand -hex 32), Bash(chmod *), Bash(./scripts/gmail-cdp-fetch.sh *)
---
...
- A Google account (W&B Workspace)
...
- Ask the document owner to share it with your W&B email
