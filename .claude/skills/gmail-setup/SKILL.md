...
3. Settings:
   ...
   - **Execute as**: `Me`
   - **Who has access**: `Only myself` (most secure — read-only access to your own inbox)
4. Click **Deploy**
