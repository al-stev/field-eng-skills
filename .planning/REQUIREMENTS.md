...
- [ ] **JIRA-03**: Issue URLs in dashboards and FE-UPDATE comments point to coreweave.atlassian.net/browse/WB-XXXX
- [ ] **JIRA-04**: CLAUDE.md, atlassian.md rules, and credential table updated to reference new instance
- [ ] **JIRA-05**: All downstream skills that consume Jira data (customer-snapshot, jira-check, cadence-prep, pre-read, 3p-update) produce correct output after migration
